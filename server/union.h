...
<body>
    ...
    <main>
        ...
        <div class="container-r">
            ...
            <div id="disp-box">
                ...
                <input type="number" class="form-input input-conf" value="199.5">
    ...
    <script type="module">
        ...
        function medidas() {
            ...
            const lecturas = ['B1(V)', 'B2(V)', 'B3(V)', 'B4(V)', 'B5(V)', 'B6(V)', 'VT(V)','I(mA)', 'T°C'];
            const especial = ['mA', '°C'];
        ...
        function getinfo() {
            ...
            let med = c[0]-c[2];
            const lecturas = ['B1(V)', 'B2(V)', 'B3(V)', 'B4(V)', 'B5(V)', 'B6(V)', 'VT','Cbat', 'T°C'];
